...
class Return_book(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(262, 436)
        self.label_10 = QtWidgets.QLabel(Dialog)
        self.label_10.setGeometry(QtCore.QRect(120, 10, 131, 41))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        ...
        self.widget.setGeometry(QtCore.QRect(10, 50, 235, 321))
        ...
        self.pushButton.clicked.connect(Dialog.book_return)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_10.setText(_translate("Dialog", "归还书籍"))
        self.pushButton.setText(_translate("Dialog", "确认归还"))
        self.label.setText(_translate("Dialog", "还书人:"))
